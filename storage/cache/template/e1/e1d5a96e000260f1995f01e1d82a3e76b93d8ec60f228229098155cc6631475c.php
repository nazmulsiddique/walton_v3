...
\t<form action=\"";
        ...
        yield "\" method=\"post\" class=\"bb-btn-group-form flex relative max-[991px]:ml-[20px] max-[767px]:m-[0]\" action=\"#\">
...
\t</form>
    ...
    public function getSourceContext(): Source
    {
        return new Source("
<div class=\"header-search w-[650px] max-[1399px]:w-[550px] max-[1199px]:w-[400px] max-[991px]:w-full max-[991px]:min-w-[300px] max-[767px]:py-[15px] max-[480px]:min-w-[auto]\">
\t<form action=\"{{ action }}\" method=\"post\" class=\"bb-btn-group-form flex relative max-[991px]:ml-[20px] max-[767px]:m-[0]\" action=\"#\">
